...
var URL_DEFAULT = "http://mighty-badlands-3324.herokuapp.com/";
...
var restlerUrl = function(url,checksfile)
{
    rest.get(url).on('complete', function(result) {
          ...
          return checkResult(result,checksfile); }
});
...
if(require.main == module) {
    ...
    if (program.file!=null)
    {
        ...
        var checkJson = checkResult(file, program.checks);
    }
    else if ( program.url!=null)
    {
        restlerUrl(program.url, program.checks);
    }
